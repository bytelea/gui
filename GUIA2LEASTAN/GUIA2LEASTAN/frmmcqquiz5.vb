Public Class frmmcqquiz5

    Private Sub frmmcqquiz5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Score = 0
        lblcorrectanswer.Text = "Correct answer for test purposes =  " & correct_answer(4)
        lblQ.Text = numbers(4)
        lblQuestion.Text = question(4)
        lblAnsA.Text = answerA(4)
        lblAnsB.Text = answerB(4)
        lblAnsC.Text = answerC(4)
        lblAnsD.Text = answerD(4)
