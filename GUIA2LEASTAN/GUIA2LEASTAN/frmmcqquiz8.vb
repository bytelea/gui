Public Class frmmcqquiz8


    Private Sub frmmcqquiz8_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Score = 0
        lblcorrectanswer.Text = "Correct answer for test purposes =  " & correct_answer(7)
        lblQ.Text = numbers(7)
        lblQuestion.Text = question(7)
        lblAnsA.Text = answerA(7)
        lblAnsB.Text = answerB(7)
        lblAnsC.Text = answerC(7)
        lblAnsD.Text = answerD(7)
