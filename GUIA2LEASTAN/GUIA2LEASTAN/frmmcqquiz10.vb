Public Class frmmcqquiz10

    Private Sub frmmcqquiz10_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Score = 0
        lblcorrectanswer.Text = "Correct answer for test purposes =  " & correct_answer(9)
        lblQ.Text = numbers(9)
        lblQuestion.Text = question(9)
        lblAnsA.Text = answerA(9)
        lblAnsB.Text = answerB(9)
        lblAnsC.Text = answerC(9)
        lblAnsD.Text = answerD(9)
