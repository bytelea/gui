Public Class frmmcqquiz6

    Private Sub frmmcqquiz6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Score = 0
        lblcorrectanswer.Text = "Correct answer for test purposes =  " & correct_answer(5)
        lblQ.Text = numbers(5)
        lblQuestion.Text = question(5)
        lblAnsA.Text = answerA(5)
        lblAnsB.Text = answerB(5)
        lblAnsC.Text = answerC(5)
        lblAnsD.Text = answerD(5)
