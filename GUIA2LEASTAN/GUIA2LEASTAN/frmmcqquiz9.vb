Public Class frmmcqquiz9

    Private Sub frmmcqquiz9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Score = 0
        lblcorrectanswer.Text = "Correct answer for test purposes =  " & correct_answer(8)
        lblQ.Text = numbers(8)
        lblQuestion.Text = question(8)
        lblAnsA.Text = answerA(8)
        lblAnsB.Text = answerB(8)
        lblAnsC.Text = answerC(8)
        lblAnsD.Text = answerD(8)
